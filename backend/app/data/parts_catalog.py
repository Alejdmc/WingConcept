...
ACCESSORIES = [
    ("cruise-control", "Cruise Control", 25, ["vanguard", "nomadic"], "/images/parts/cruise-control.png",
    ...
    ("rear-mirror", "Rear Mirror", 25, ["vanguard", "nomadic"], "/images/parts/rear-mirror.png",
    ...
    ("fuel-gauge-vanguard", "Analog Fuel Gauge (Vanguard)", 119, ["vanguard"],
     "/images/parts/fuel-gauge-vanguard.png", "Analog fuel gauge for the Vanguard L-shaped tank."),
    ("auxiliary-lights", "Auxiliary Lights Kit", 187.10, ["vanguard"],
     "/images/parts/auxiliary-lights.png", "LED lights, position indicators, switch and wiring."),
    ...
    ("electrical-kit", "Complete Electrical Installation Kit", 218.20, ["vanguard", "nomadic"],
     "/images/parts/electrical-kit.png", "Full wiring harness for the selected engine."),
    ("carabiners", "Two Carabiners", 90, ["vanguard", "nomadic"], "/images/parts/carabiners.png",
