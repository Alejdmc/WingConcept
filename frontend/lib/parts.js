...
export const PARTS = [
  ...
  { id: 'front-bar-protection', name: 'Protection with Front Bar Handle', price: 80, compatibleWith: ['vanguard', 'nomadic'], productoId: null, image: '/images/parts/front-bar-protection.png', description: 'Structural front protection bar that serves a dual purpose as a convenient handgrip or handle.' },
  ...
  { id: 'rock-guard', name: 'Nomadic Rock Guard', price: 95, compatibleWith: ['nomadic'], productoId: null, image: '/images/parts/rock-guard.png', description: 'Heavy-duty guard designed to protect the lower trike body from kicking up rocks, gravel, and field debris.' },
]
