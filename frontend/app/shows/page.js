...
export default function ShowsPage() {
  ...
  const shows = content.shows?.length ? content.shows : (content.items?.length ? content.items : FALLBACK.shows)
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <SafeImage src={hero.imagen} alt="Shows" fill className="object-cover" priority fallbackSrc="/images/front1.jpg" />
      ...
      <section className="py-24 px-6 bg-bg2">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl font-black uppercase text-ink mb-4">Upcoming Shows</h2>
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-brand to-brand/80">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h2 className="text-3xl sm:text-5xl font-black uppercase mb-8">Don&apos;t Miss Our Next Show</h2>
