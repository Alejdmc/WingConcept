...
import { ADVENTURE_FALLBACK } from '@/lib/staticContent'

const FALLBACK = ADVENTURE_FALLBACK
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center">
            <Link
              href="/tourist-flight"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-brand text-white font-bold uppercase tracking-wide text-sm hover:bg-brand/90 transition-all">
              See Rates, Location & Induction Course
